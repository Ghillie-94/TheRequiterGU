...
WinPanel::WinPanel(sf::RenderWindow* newWindow)
	: background()
	, title()
	, message()
	, position(0,0)
...
void WinPanel::Update(sf::Time frameTime)
{
...
void WinPanel::Draw(sf::RenderTarget& target)
{
...
void WinPanel::SetPosition(sf::Vector2f newPosition)
{
